...
*/
    ...
    void bulkUpdate() {
        ...
        // member3 = 30 -> 회원
        // member4 = 40 -> 회원
        // 벌크 연산을 한 후에 영속성 컨텍스트 초기화 하는거 추천
        // 이유 : 벌크 연산을하면 디비와 영속성 컨텍스트의 내용이 달라짐
        // 디비에 적용됐는데 select를 하면 영속성 컨텍스트의 내용이 나옴
        // 이유는 영속성 컨텍스트가 디비에서 오는 데이터보다 우선순위를 가지기 때문
